...
class MainViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // 첫페이지 설정
        showViewController(viewController: UINavigationController.self, storyboardId: "HomeID")
...
extension MainViewController: SideMenuViewControllerDelegate {
    func selectedCell(_ row: Int) {
        ...
        case 0:
            // 홈
            self.showViewController(viewController: UINavigationController.self, storyboardId: "HomeID")
            self.navBar.topItem!.title = "Home"
        case 1:
            // 알람
            self.showViewController(viewController: UINavigationController.self, storyboardId: "AlarmID")
            self.navBar.topItem!.title = "Alarm"
        case 2:
            // 투두리스트
            self.showViewController(viewController: UINavigationController.self, storyboardId: "TodoID")
            self.navBar.topItem!.title = "Todo List"
        default:
            break
        }

        // 선택 끝나면 비동기로 sidemenu 접기
